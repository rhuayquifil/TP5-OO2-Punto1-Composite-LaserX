...
public class MandosMediosEmpleado implements Empleado {
	...
	public MandosMediosEmpleado(String nombre, String apellido, int sueldo) {
		super();
		this.sueldo = sueldo;
		this.nombre = nombre;
	...
	public void info() {
		System.out.println("Mandos Medios: " + nombre + " " + apellido + ", sueldo: " + sueldo);
